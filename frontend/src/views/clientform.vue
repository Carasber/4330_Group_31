...
<template>
  <main>
    ...
    <div>
      <photo-upload @file-uploaded="handleFileUpload"></photo-upload>
    </div>
    <!-- ProfileUpload call function -->
    <div class="px-10 py-20">
      <!-- form field -->
      <!-- @submit.prevent stops the submit event from reloading the page-->
      <form @submit.prevent="submitForm">
        <input type="hidden" v-model="client.picture_path" name="client.picture_path" />
        <!-- grid container -->
...
export default {
  ...
  methods: {
    ...
    handleFileUpload(filePath) {
      this.client.picture_path = filePath;
    }
  }
}
</script>
