  ...
  <main>
    ...
    <div class="px-10 py-20">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10">
        ...
        <div class="flex justify-between mt-10 mr-20">
          <button @click="deleteDialog" class="bg-red-700 disabled:opacity-50 text-white rounded"
            :disabled="user.role === 'viewer'">
            Delete Client
          </button>
          <!--This button will confirm or cancel based on what the client wishes to be done-->
          <delete-dialog 
...
<!--Notice that the Photo Upload is impotant and used from components-->
<!--Notice that the Dialog Box is important and used from components-->
<script>
...
export default {
  // register components for upload photo
  components: {
    PhotoUpload,
    DeleteDialog,
    VueMultiselect,
